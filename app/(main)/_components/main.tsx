    ...
    <main className="grid md:grid-cols-2 bg-black md:min-h-screen">
      ...
      >
        <div>
          ...
          >
            Roger <motion.span variants={FadeInFromRight}>Remaut.</motion.span>
          </motion.h1>
          <motion.h2
            variants={FadeInFromRight}
            initial="hidden"
          ...
          <div className="hidden md:block">
            ...
            >
              ...
              infused with the essence of modern art. My work isn&apos;t created
              to please an audience; rather, I am the audience, relishing in my
              own performance.
            </motion.p>
            <motion.div
      ...
      >
        ...
        >
          My identity as an artist was crafted by breaking free from
          conventional teachings, embracing a distinctive, informal style,
          infused with the essence of modern art. My work isn&apos;t created to
          please an audience; rather, I am the audience, relishing in my own
          performance.
        </p>
        <div className="flex">
          <Button
